(function(){
  ...
  var fourImagesCopy = {
    ...
    "callToActionMessage": "FIND YOUR FAVORITE DRIVING ACCESSORY",
    "callToActionButtonText": "LET'S GO!",
    "gameMessageTextOne": "1. WHICH PICTURE DESCRIBES WHY YOU DRIVE MORE OFTEN?",
    "gameMessageTextTwo": "2. WHICH TYPE OF DRIVER ARE YOU?",
    "gameMessageTextThree": "3. WHICH OF THESE GADGETS DO YOU ALREADY OWN? (TICK ALL THAT APPLY)",
    "resultMessageHeader": "YOU USUALLY HAVE IMPORTANT PASSENGERS ALONG FOR THE RIDE!.",
  ...
  var presentFinalScreen = function()
  {
    ...
    interactionContainer.removeChild($('.itemDescription'));
